...
## Extending to multiple scenarios and replicates {.tight}
...
:::{.column width="50%"}
![](/imgaes/miracle_occurs.png){width="60%" fig-align="center"}
:::
::::
...
- Assess chronological uncertainty combined with proxy uncertainty
- Extend underlying dynamics to include hysteresis
